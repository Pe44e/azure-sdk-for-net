...
internal class FunctionCall
{
    ...
    public FunctionCall(string name, Dictionary<string, FunctionArgument> arguments)
    {
        this.name = name;
...
{
    public List<BasicToolCallAttributes> tool_call { get; set; }
    public ToolCallAttribute(List<BasicToolCallAttributes> tool_call)
    {
...
[JsonSerializable(typeof(Dictionary<string, FunctionArgument>))]
